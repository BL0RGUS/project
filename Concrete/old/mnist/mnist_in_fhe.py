...
def compile_and_test(
    ...
    configuration = Configuration(
        enable_unsafe_features=use_virtual_lib,  # This is for our tests only, never use that in prod
        use_insecure_key_cache=use_virtual_lib,  # This is for our tests only, never use that in prod
...
def main():
    ...
    lr = 0.02
    gamma = 0.33
    test_data_length_reduced = 10  # This is notably the length of the computation in FHE
