...
print(trainer.test(args, num_epochs)[0].get_avg("acc"))
...
print("HELLO")
#print(trainer.test(args, num_epochs)[0].print_all())
## RELU_range_aware
if debug_mode:
    num_epochs = 1
    batch_size = 500
...
args.num_epochs = num_epochs
args.lr=0.005
args.from_checkpoint = "outputs/mltoolbox/range_aware/AlexNet_last_checkpoint.pth.tar"
args.range_awareness_loss_weight=0.1
args.range_aware_train = True
args.save_dir = "outputs/mltoolbox/polynomial6"
